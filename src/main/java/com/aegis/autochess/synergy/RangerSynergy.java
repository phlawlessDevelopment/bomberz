...
@Component
public class RangerSynergy implements SynergyStrategy {
    
    private static final String BONUS_TYPE = "attack_speed";
    ...
    private static final int BONUS_SIX = 65;
    private static final int BONUS_FOUR = 40;
    private static final int BONUS_TWO = 15;
